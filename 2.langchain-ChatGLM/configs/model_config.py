...
embedding_model_dict = {
    ...
    "text2vec": "GanymedeNil/text2vec-large-chinese", # './text2vec-large-chinese'
...
llm_model_dict = {
    ...
    "chatglm2-6b": {
        ...
        "local_model_path": "/root/autodl-tmp/models/chatglm2-6b/", # 离线模型路径
        "provides": "ChatGLMLLMChain"
    },
    "chatglm2-6b-int4": {
...
PROMPT_TEMPLATE = """问题：{question}  的答案"""
